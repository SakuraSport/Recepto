...
| Скриншот                                                  | Описание |
|-----------------------------------------------------------|---------|
| ![Главная страница](screenshots/01-homepage1.png)         | 🏠 Главная страница со светлой темой |
| ![Тёмная тема](screenshots/02-dark-theme2.png)            | 🌙 Тёмная тема с элегантным чёрным дизайном |
| ![Поиск и фильтрация](screenshots/03-search-recipes1.png) | 🔍 Поиск и фильтрация по категориям |
