...
| Скриншот | Описание |
|----------|---------|
| ![Главная страница](screenshots/01-homepage.png) | 🏠 Главная страница со светлой темой и карточками рецептов |
| ![Тёмная тема](screenshots/02-dark-theme.png) | 🌙 Тёмная тема с элегантным чёрным дизайном |
| ![Поиск и фильтрация](screenshots/03-search-recipes.png) | 🔍 Мощный поиск и фильтрация по категориям |
| ![Профиль пользователя](screenshots/04-user-profile.png) | 👤 Личный профиль с рецептами и статистикой |
| ![Админ-панель](screenshots/05-admin-panel.png) | 🔧 Django админ-панель для управления контентом |
