...
| Скриншот                                                | Описание |
|---------------------------------------------------------|---------|
| ![Главная страница](screenshots/01-homepage.png)        | 🏠 Главная страница со светлой темой |
| ![Тёмная тема](screenshots/02-dark-theme.png)           | 🌙 Тёмная тема с элегантным чёрным дизайном |
| ![Поиск и фильтрация](screenshots/03-search-recipes.png) | 🔍 Поиск и фильтрация по категориям |
